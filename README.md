...
![plot](Figure_1.png)
_Figure 1: Scatter plot of 7DADM vs DM for all RAFT grids and days from 2000-2023, NOTE: ${\color{#ef3bff}MAGENTA}$ line shows EPA thermal criteria of 20C_
...
![plot](Figure_2.png)
_Figure 2: Scatter plot of 7DADM vs DM for all RAFT grids and days from 2000-2023 stratified by month, NOTE: $${\color{#ef3bff}MAGENTA}$$ line shows EPA thermal criteria of 20C_
